...
mod tests {
	...
	fn test_encode() {
		...
		assert_eq!(mangle("Hello/😀/World"), "__TURBOPACK__Hello$2f_1f600$$2f$World__");
		assert_eq!(mangle("Hello😀😀World"), "__TURBOPACK__Hello$_1f600$$_1f600$World__");
	}
	...
	fn test_decode() {
		...
		assert_eq!(unmangle("__TURBOPACK__Hello$2f2f2f$World__"), "Hello///World");
		...
		assert_eq!(unmangle("__TURBOPACK__Hello$_1f600$World__"), "Hello😀World");
		assert_eq!(unmangle("__TURBOPACK__Hello$2f_1f600$$2f$World__"), "Hello/😀/World");
		assert_eq!(unmangle("__TURBOPACK__Hello$_1f600$$_1f600$World__"), "Hello😀😀World");
	}
