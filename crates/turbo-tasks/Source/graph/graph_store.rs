...
where
	StoreImpl: GraphStore,
{
	pub fn new(store:StoreImpl) -> Self { Self { store, visited:Default::default() } }
}
	...
	StoreImpl: GraphStore,
{
	...
	pub fn into_inner(self) -> StoreImpl { self.store }
}
