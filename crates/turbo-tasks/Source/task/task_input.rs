...
impl TaskInput for ConcreteTaskInput {
	fn try_from_concrete(input:&ConcreteTaskInput) -> Result<Self> { Ok(input.clone()) }

	fn into_concrete(self) -> ConcreteTaskInput { self }
}
...
impl TaskInput for RcStr {
	...
	fn into_concrete(self) -> ConcreteTaskInput { ConcreteTaskInput::String(self) }
}
...
impl TaskInput for bool {
	...
	fn into_concrete(self) -> ConcreteTaskInput { ConcreteTaskInput::Bool(self) }
}
	...
	T: TaskInput,
{
	...
	fn into_concrete(self) -> ConcreteTaskInput {
		ConcreteTaskInput::List(
			self.into_iter().map(|i| <T as TaskInput>::into_concrete(i)).collect::<Vec<_>>(),
		)
	}
}
...
impl TaskInput for u8 {
	...
	fn into_concrete(self) -> ConcreteTaskInput { ConcreteTaskInput::U8(self) }
}
...
impl TaskInput for u16 {
	...
	fn into_concrete(self) -> ConcreteTaskInput { ConcreteTaskInput::U16(self) }
}
...
impl TaskInput for u32 {
	...
	fn into_concrete(self) -> ConcreteTaskInput { ConcreteTaskInput::U32(self) }
}
...
impl TaskInput for i32 {
	...
	fn into_concrete(self) -> ConcreteTaskInput { ConcreteTaskInput::I32(self) }
}
...
impl TaskInput for u64 {
	...
	fn into_concrete(self) -> ConcreteTaskInput { ConcreteTaskInput::U64(self) }
}
...
impl TaskInput for usize {
	...
	fn into_concrete(self) -> ConcreteTaskInput { ConcreteTaskInput::Usize(self) }
}
	...
	fn try_from_concrete(input:&ConcreteTaskInput) -> Result<Self> {
		match input {
			ConcreteTaskInput::TaskCell(task, index) => {
				Ok(Vc { node:RawVc::TaskCell(*task, *index), _t:PhantomData })
			},
			ConcreteTaskInput::TaskOutput(task) => {
				Ok(Vc { node:RawVc::TaskOutput(*task), _t:PhantomData })
			},
	...
	T: Send + Sync + 'static,
{
	...
	fn into_concrete(self) -> ConcreteTaskInput { ConcreteTaskInput::SharedReference(self.into()) }
}
...
mod tests {
	...
	fn test_multiple_named_fields() -> Result<()> {
		...
		test_conversion!(MultipleNamedFields { named:42, other:"42".into() });
		Ok(())
	}
	...
	fn test_nested_variants() -> Result<()> {
		...
		test_conversion!(NestedVariants::Variant5 { named:OneVariant::Variant, other:"42".into() });
		test_conversion!(NestedVariants::Variant2(
			MultipleVariantsAndHeterogeneousFields::Variant5 { named:42, other:"42".into() }
		));
		Ok(())
	}
}
