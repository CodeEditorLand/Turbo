...
impl Attrs {
	pub fn bold(&self) -> bool { self.mode & TEXT_MODE_BOLD != 0 }
	...
	pub fn italic(&self) -> bool { self.mode & TEXT_MODE_ITALIC != 0 }
	...
	pub fn underline(&self) -> bool { self.mode & TEXT_MODE_UNDERLINE != 0 }
	...
	pub fn inverse(&self) -> bool { self.mode & TEXT_MODE_INVERSE != 0 }
