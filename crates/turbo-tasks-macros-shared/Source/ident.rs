...
pub fn get_register_value_type_ident(struct_ident:&Ident) -> Ident {
	Ident::new(&format!("__register_{struct_ident}_value_type"), struct_ident.span())
}
...
pub fn get_native_function_ident(ident:&Ident) -> Ident {
	Ident::new(&format!("{}_FUNCTION", ident.to_string().to_uppercase()), ident.span())
}

pub fn get_native_function_id_ident(ident:&Ident) -> Ident {
	Ident::new(&format!("{}_FUNCTION_ID", ident.to_string().to_uppercase()), ident.span())
}

pub fn get_trait_type_ident(ident:&Ident) -> Ident {
	Ident::new(&format!("{}_TRAIT_TYPE", ident.to_string().to_uppercase()), ident.span())
}
...
pub fn get_internal_trait_impl_function_ident(trait_ident:&Ident, ident:&Ident) -> Ident {
	Ident::new(&format!("__trait_call_{trait_ident}_{ident}"), trait_ident.span())
}
...
pub fn get_trait_type_id_ident(ident:&Ident) -> Ident {
	Ident::new(&format!("{}_TRAIT_TYPE_ID", ident.to_string().to_uppercase()), ident.span())
}
...
pub fn get_value_type_ident(ident:&Ident) -> Ident {
	Ident::new(&format!("{}_VALUE_TYPE", ident.to_string().to_uppercase()), ident.span())
}

pub fn get_value_type_id_ident(ident:&Ident) -> Ident {
	Ident::new(&format!("{}_VALUE_TYPE_ID", ident.to_string().to_uppercase()), ident.span())
}

pub fn get_value_type_init_ident(ident:&Ident) -> Ident {
	Ident::new(&format!("{}_VALUE_TYPE_INIT", ident.to_string().to_uppercase()), ident.span())
}
