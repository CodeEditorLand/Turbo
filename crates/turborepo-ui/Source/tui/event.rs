...
pub enum Event {
	...
	Status { task:String, status:String, result:CacheResult },
	...
	ScrollUp,
	ScrollDown,
	SetStdin { task:String, stdin:Box<dyn std::io::Write + Send> },
	EnterInteractive,
	ExitInteractive,
	Input { bytes:Vec<u8> },
	...
	TogglePinnedTask,
	SearchEnter,
	SearchExit { restore_scroll:bool },
	SearchScroll { direction:Direction },
