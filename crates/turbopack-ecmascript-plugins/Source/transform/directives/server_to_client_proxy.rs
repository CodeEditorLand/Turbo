use swc_core::{
	...
	ecma::{
		ast::{
			ImportDecl, ImportDefaultSpecifier, ImportSpecifier, ImportStarAsSpecifier, Module, ModuleDecl, ModuleItem,
			Program,
		},
		utils::private_ident,
	},
...
pub fn create_proxy_module(transition_name: &str, target_import: &str) -> Program {
	...
	Program::Module(Module {
		body: vec![
			...
			ModuleItem::Stmt(quote!("__turbopack_export_namespace__($proxy);" as Stmt, proxy = ident,)),
		],
		shebang: None,
		span: DUMMY_SP,
	})
