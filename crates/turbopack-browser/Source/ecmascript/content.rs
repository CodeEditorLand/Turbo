...
use super::{
	...
	content_entry::EcmascriptDevChunkContentEntries,
...
impl EcmascriptDevChunkContent {
	...
	pub(crate) async fn new(
		...
		let entries = EcmascriptDevChunkContentEntries::new(content).resolve().await?;
		Ok(EcmascriptDevChunkContent { entries, chunking_context, chunk }.cell())
	}
