...
where
	...
	match FutureRetry::new(func, FsRetryHandler { max_attempts:MAX_RETRY_ATTEMPTS }).await {
		Ok((r, _attempts)) => Ok(r),
...
fn get_retry_wait_time(attempt:usize) -> Duration { Duration::from_millis((attempt as u64) * 100) }
