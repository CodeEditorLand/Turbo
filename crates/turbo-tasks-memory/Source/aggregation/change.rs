...
pub enum PreparedChangeRef<'l, C:AggregationContext> {
	Borrowed { uppers:StackVec<C::NodeRef>, change:&'l C::DataChange },
	Owned { uppers:StackVec<C::NodeRef>, change:C::DataChange },
}
