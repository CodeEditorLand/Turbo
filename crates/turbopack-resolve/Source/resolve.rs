...
async fn base_resolve_options(
	...
	Ok(ResolveOptions {
		...
		into_package:{
			...
			if opt.browser {
				resolve_into.push(ResolveIntoPackage::MainField { field:"browser".into() });
			}
			if opt.module {
				resolve_into.push(ResolveIntoPackage::MainField { field:"module".into() });
			}
			resolve_into.push(ResolveIntoPackage::MainField { field:"main".into() });
			resolve_into
		},
		in_package:{
