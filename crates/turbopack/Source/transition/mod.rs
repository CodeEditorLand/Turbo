...
use crate::{ModuleAssetContext, module_options::ModuleOptionsContext};
...
pub trait Transition {
	...
	fn process_source(self: Vc<Self>, asset:Vc<Box<dyn Source>>) -> Vc<Box<dyn Source>> { asset }
	...
	fn process_layer(self: Vc<Self>, layer:Vc<RcStr>) -> Vc<RcStr> { layer }
...
impl ValueDefault for TransitionsByName {
	...
	fn value_default() -> Vc<Self> { Vc::cell(Default::default()) }
}
